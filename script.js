                ...
                try {
                    ...
                    canvas.toBlob(async (blob) => {
                        if (blob) {
                            ...
                            console.log(`프레임 추출 완료: ${frames.length}개 프레임`);
                            resolve(frames);
                        } else {
...
async function generatePdf() {
    ...
    try {
        ...
        console.log(`PDF 생성 단계 4: GIF 이미지 삽입 (${gifFrames.length}개 프레임)`);
